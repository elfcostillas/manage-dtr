    ...
    <div class="flex gap-2" >
        ...
        <div class="flex-none">
            <Card style="width:auto;">
                <template #title>Goverment Loan </template>
                <template #content>
...
<script setup>
    ...
    import { useGovtLoanStore } from '@/stores/govtloan';
    ...
    const deduction_store = useGovtLoanStore();
    ...
    onMounted(async () => {
        ...
        let types = await deductiontype_store.getLoanTypes();
