...
export const useManageDTRStore = defineStore("manageDTRStore", () => {
    ...
    const completeLog = async () => {
        ...
        try{
            const { data } = await getFN(`api/timekeeping/manage-dtr-semi/complete-logs/${selectedPeriod.value}/${selectedEmployee.value}`,null);
            dtr_data.value = data;
        }catch(error){
    ...
    const clearLog = async () => {
        ...
        try{
            const { data } = await getFN(`api/timekeeping/manage-dtr-semi/clear-logs/${selectedPeriod.value}/${selectedEmployee.value}`,null);
            dtr_data.value = data;
        }catch(error){
